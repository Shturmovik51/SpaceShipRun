...
//            using (var scope = new EditorGUI.ChangeCheckScope())
//            {
//                //_worldScreenHeight = EditorGUILayout.FloatField("WorldScreenHeight", _worldScreenHeight);
//                //_renderTextureHeight = EditorGUILayout.IntField("RenderTextureHeight", _renderTextureHeight);
